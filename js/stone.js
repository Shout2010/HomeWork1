const rockPaperScissor = () => {
    ...
    if (userVersion.toLowerCase() === versionArr[0] && computerVersion === versionArr[1]) {
        alert(`Победа!!! Ваш выбор: ${userVersion}, выбор компьютера: ${computerVersion}.`);
    } else if (userVersion.toLowerCase() === versionArr[1] && computerVersion === versionArr[2]) {
        alert(`Победа!!! Ваш выбор: ${userVersion}, выбор компьютера: ${computerVersion}.`);
    } else if (userVersion.toLowerCase() === versionArr[2] && computerVersion === versionArr[0]) {
        alert(`Победа!!! Ваш выбор: ${userVersion}, выбор компьютера: ${computerVersion}.`);
    } else if (userVersion.toLowerCase() === computerVersion){
